    ...
    public function __construct(
        ...
        if (!isset(self::UPLOAD_ERRORS[$error])) {
            throw new InvalidArgumentException(
                "Invalid error status. Error status must be the value of one of the 'UPLOAD_ERR_*' constants."
            );
        }
        ...
        if (is_string($fileOrStream)) {
            ...
            throw new InvalidArgumentException(
                "Invalid file provided. File must be a string, a resource or an object implementing StreamInterface."
            );
        }
