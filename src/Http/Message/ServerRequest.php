...
{
    /** @var array<string, string> Request environment. */
    private array $serverParams = [];

    /** @var array<string, string> Cookies sent by the client. */
    private array $cookieParams = [];

    /** @var array<string, string> Query string arguments. */
    private array $queryParams = [];

    /** @var array<UploadedFileInterface> An array of UploadedFileInterface instances with files sent by the client. */
    private array $uploadedFiles = [];

    /** @var object|array<string, string>|null Parsed body. */
        ...
        foreach ($uploadedFiles as $uploadedFile) {
            if (!($uploadedFile instanceof UploadedFileInterface)) {
                throw new InvalidArgumentException(
                    ...
                    "Argument should be an array of objects implementing UploadedFileInterface."
                );
            }
        }
     ...
     * updated body parameters.
     *
     * @param null|array<string, string>|object $data The deserialized body data. This will
    ...
    public function withParsedBody($data): static
    {
        if (!(is_null($data) || is_array($data) || is_object($data))) {
            throw new InvalidArgumentException("Provided argument must be of type array, null or an object.");
        }
